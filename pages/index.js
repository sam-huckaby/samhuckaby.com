...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 dark:bg-gray-500">
      <Head>
      ...
      <main className="grid grid-cols-2 gap-2 w-full p-8 max-w-4xl">
        ...
        <div className="border-t-4 border-black flex flex-col">
          <div className="pt-3 pb-1">
            ...
            <div className="text-gray-500 dark:text-zinc-300 text-xs">NextJS, Supabase, Vercel</div>
          ...
          <div className="pt-3 pb-1">
            ...
            <div className="text-gray-500 dark:text-zinc-300 text-xs">NextJS, TBD</div>
          ...
          <div className="pt-3 pb-1">
            ...
            <div className="text-gray-500 dark:text-zinc-300 text-xs">Angular, ExpressJS, MongoDB, Docker, Amazon Lightsail</div>
